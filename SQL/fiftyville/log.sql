...
--Looking for cars that left the bakery (witness 1)
...
--ADD phones of reciever and caller to table
UPDATE phone_calls
...
--Witness 3 call and plane ticket bought
